...
class Ant(Insect):
    ...
    def add_to(self, place):
        if place.ant is None:
            ...
            elif self.is_container and self.can_contain(place.ant) and not place.ant.is_container:
                #call store ant on place.ant and rebind place.ant 
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        in_range = 0
        while current_position.is_hive == False:
...
class WallAnt(Ant):
    """An ant that does nothing; large health value"""
...
class HungryAnt(Ant):
    """
    Chews a random bee in the same place as itself only when it finishes chewing after 3 turns.
    """
    time_to_chew = 3
    food_cost = 4
    implemented = True
...
class ContainerAnt(Ant):
    ...
    def can_contain(self, other):
        # BEGIN Problem 8
        "*** YOUR CODE HERE ***"
        '''check if there is no ant contained in self, AND other is not a container ant
        if both are True, then it can contain
        
        '''
        if self.is_container and not self.ant_contained and not other.is_container:
            return True
        return False
        # END Problem 8
    ...
    def store_ant(self, ant):
        ...
        "*** YOUR CODE HERE ***"
        '''
        set self.ant_contained to store ant '''
    ...
    def action(self, gamestate):
        # BEGIN Problem 8
        "*** YOUR CODE HERE ***"
        ''' if there is an ant contained, call that ant's action method'''
...
# END Problem 12
    ...
    def action(self, gamestate):
        ...
        while current_position.exit:
            if current_position.ant:
                current_position.ant.double()
                if current_position.ant.is_container and current_position.ant.ant_contained:
                    current_position.ant.ant_contained.double()
    ...
    def remove_ant(self, place):
        #if type of ant = queenant return none 
        if type(self) == QueenAnt:
            return 
        super().remove_ant(place)
